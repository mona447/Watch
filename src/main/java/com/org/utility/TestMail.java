...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "monalisa.behera447@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Watch Your Wrist/h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Watch Your Wrist.<br>"
					+ "We are glad that you choose <bold>us. We invite you to check out our latest collection of new watches."
					+ "<br>We are providing upto 60% OFF on most of the smart watches. So please visit our site and explore the collections. <br>"
					+ " <br>Our Online watches is growing in a larger amount these days and we are in high demand so we thanks all of you for "
					...
					+ "<span class='greenText'>MONA500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
