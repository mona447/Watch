...
<%@ page
	import="com.org.service.impl.*, com.org.service.*,com.org.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="noise"
								<%="noise".equalsIgnoreCase(ptype) ? "selected" : ""%>>Noise</option>
							<option value="tressBerry"
								<%="tressBerry".equalsIgnoreCase(ptype) ? "selected" : ""%>>TressBerry</option>
							<option value="rolex"
								<%="rolex".equalsIgnoreCase(ptype) ? "selected" : ""%>>Rolex</option>
							<option value="casio"
								<%="casio".equalsIgnoreCase(ptype) ? "selected" : ""%>>Casio</option>
							<option value="titon"
								<%="titon".equalsIgnoreCase(ptype) ? "selected" : ""%>>Titon</option>
							<option value="sonata"
								<%="sonata".equalsIgnoreCase(ptype) ? "selected" : ""%>>Sonata</option>
							<option value="boat"
								<%="boat".equalsIgnoreCase(ptype) ? "selected" : ""%>>Boat</option>
						</select>
					</div>
				</div>
				<div class="form-group">
